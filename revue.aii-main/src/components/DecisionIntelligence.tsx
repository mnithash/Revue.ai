...
export default function DecisionIntelligence() {
  ...
  async function onSubmit() {
    ...
    try {
      ...
      const primaryUrl = process.env.REACT_APP_N8N_REVUE_URL || 'https://gnosiss.app.n8n.cloud/webhook-test/revue'
      ...
      // Console log the result from the webhook
        ...
        <div className={glassCardClass('p-5 md:p-6')}>
          <div className="flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <div className="text-sm text-white/65">Rendered from the n8n response.</div>
            </div>
          </div>
