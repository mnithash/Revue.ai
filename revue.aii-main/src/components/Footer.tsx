        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-sm text-white/70 hover:text-white transition-colors duration-300 inline-block hover:-translate-y-0.5 transition-transform duration-300">Feedback Analysis</a>
              </li>
              <li>
                <a href="#" className="text-sm text-white/70 hover:text-white transition-colors duration-300 inline-block hover:-translate-y-0.5 transition-transform duration-300">Executive Reporting</a>
              </li>
              <li>
                <a href="#" className="text-sm text-white/70 hover:text-white transition-colors duration-300 inline-block hover:-translate-y-0.5 transition-transform duration-300">Webhook Integration</a>
              </li>
              <li>
                <a href="#pricing" onClick={handlePricingClick} className="text-sm text-white/70 hover:text-white transition-colors duration-300 inline-block hover:-translate-y-0.5 transition-transform duration-300">Pricing</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#about" onClick={handleAboutClick} className="text-sm text-white/70 hover:text-white transition-colors duration-300 inline-block hover:-translate-y-0.5 transition-transform duration-300">About Us</a>
              </li>
              <li>
                <a href="#" className="text-sm text-white/70 hover:text-white transition-colors duration-300 inline-block hover:-translate-y-0.5 transition-transform duration-300">Documentation</a>
              </li>
              <li>
                <a href="#" className="text-sm text-white/70 hover:text-white transition-colors duration-300 inline-block hover:-translate-y-0.5 transition-transform duration-300">API Reference</a>
              </li>
              <li>
                <a href="#" className="text-sm text-white/70 hover:text-white transition-colors duration-300 inline-block hover:-translate-y-0.5 transition-transform duration-300">Security</a>
              </li>
            </ul>
          </div>
